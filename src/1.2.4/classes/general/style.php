...
{
    public static function GeneratorCSSAndRewrite()
    {
...
';
    ...
    public static function TableListActionCheckbox()
    {
...
';
    ...
    public static function TableListCheckbox()
    {
        $page_list_minimization_level = COption::GetOptionInt('imyie.littleadmin', 'page_list_minimization_level', 0);
        $css = '
...
';
    ...
    public static function TableListCell()
    {
        $page_list_minimization_level = COption::GetOptionInt('imyie.littleadmin', 'page_list_minimization_level', 0);
        $css = '
.adm-list-table-cell{
...
';
    ...
    public static function TableListFooter()
    {
        $page_list_minimization_level = COption::GetOptionInt('imyie.littleadmin', 'page_list_minimization_level', 0);
...
';
    ...
    public static function Gadgets()
    {
...
';
    ...
    public static function Inputs()
    {
        ...
        $constrols_input_text_border_radius = COption::GetOptionString(
            'imyie.littleadmin',
            'constrols_input_text_border_radius',
            "Y"
        );
        $constrols_input_text_box_shadow = COption::GetOptionString(
            'imyie.littleadmin',
            'constrols_input_text_box_shadow',
            "Y"
        );
        $constrols_input_text_hover_shadow = COption::GetOptionString(
            'imyie.littleadmin',
            'constrols_input_text_hover_shadow',
            "Y"
        );
        $constrols_input_text_focus_shadow = COption::GetOptionString(
            'imyie.littleadmin',
            'constrols_input_text_focus_shadow',
            "Y"
        );
...
';
    ...
    {
        $constrols_input_text_height = COption::GetOptionInt(
                'imyie.littleadmin',
                'constrols_input_text_height',
                26
            ) + 1;
        $constrols_input_text_border_radius = COption::GetOptionString(
            'imyie.littleadmin',
